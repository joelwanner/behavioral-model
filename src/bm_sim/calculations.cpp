...
struct hmac {
    uint64_t operator()(const char *buf, size_t len) const {
        ...
        uint8_t in[]  = { 0x45, 0x00, 0x01, 0xee, 0x00, 0x01, 0x00, 0x00, 0x40, 0xdd, 0x64, 0x2e, 0x0a, 0x02, 0x00, 0x01, 0x0a, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        memcpy(in, buf+16, len-16);

        hmac_helper h;
        h.main(in, (len-16)/16, out, key);
